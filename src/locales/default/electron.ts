export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Virilize server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Virilize Cloud',

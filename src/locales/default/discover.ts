export default {
  ...
  'createGuide.func1.title': 'Submit in Virilize',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Virilize Community.',
  'footer.title': 'Share your creation on Virilize Community today',
  ...
  'models.providerInfo.apiTooltip': 'Virilize supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Virilize Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Virilize automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Virilize marketplace with one click.',

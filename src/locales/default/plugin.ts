export default {
  ...
  'protocolInstall.official.badge': 'Virilize Official Skill',
  'protocolInstall.official.description': 'Official Virilize Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Virilize does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.title': 'Add skills to Virilize AI',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'Virilize Skills',

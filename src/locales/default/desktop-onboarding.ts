export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using Virilize Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Virilize. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Virilize',
  ...
  'screen5.actions.signInCloud': 'Sign in to Virilize Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Virilize Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Virilize Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Virilize server instance',
